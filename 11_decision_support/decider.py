#!/usr/bin/env python3
"""
Run Stage 1 + Stage 2 venue analysis against local Ollama.
...
USER_PROMPT_STAGE_1 = f"""Here are the couple's priorities:
...
USER_PROMPT_STAGE_2 = f"""Here are the couple's priorities:
...
def main() -> None:
    ...
    print("\nDone. Take screenshots of Stage 1 + Stage 2 outputs for submission.")
